...
flags.DEFINE_string('mnist_train_data_file', 'gs://tpu-gan-eeshan/data/train.tfrecords', 'Training .tfrecord data file')
flags.DEFINE_string('mnist_test_data_file', 'gs://tpu-gan-eeshan/data/test.tfrecords', 'Test .tfrecord data file')
